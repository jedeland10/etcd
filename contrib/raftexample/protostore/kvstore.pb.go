...
type KVSnapshot struct {
	Entries []*MyKV `protobuf:"bytes,1,rep,name=entries" json:"entries,omitempty"`
}
...
func (m *KVSnapshot) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KVSnapshot) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KVSnapshot.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KVSnapshot) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KVSnapshot.Merge(m, src)
}
func (m *KVSnapshot) XXX_Size() int {
	return m.Size()
}
func (m *KVSnapshot) XXX_DiscardUnknown() {
	xxx_messageInfo_KVSnapshot.DiscardUnknown(m)
}

var xxx_messageInfo_KVSnapshot proto.InternalMessageInfo

func init() {
	proto.RegisterType((*MyKV)(nil), "protostore.MyKV")
	proto.RegisterType((*KVSnapshot)(nil), "protostore.KVSnapshot")
}
...
var fileDescriptor_088d7f6aff848d9e = []byte{
	...
	0x91, 0xf4, 0xfc, 0xf4, 0x7c, 0x30, 0x5f, 0x1f, 0xc4, 0x82, 0xa8, 0x50, 0x0a, 0xe1, 0x62, 0xf1,
	...
	,
...
func (m *MyKV) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintKvstore(dAtA, i, uint64(m.ProposalID))
	i--
	dAtA[i] = 0x18
	if m.Value == nil {
...
func (m *KVSnapshot) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KVSnapshot) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KVSnapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MyKV) Size() (n int) {
	...
	n += 1 + sovKvstore(uint64(m.ProposalID))
	return n
}

func (m *KVSnapshot) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *KVSnapshot) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KVSnapshot: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KVSnapshot: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Entries = append(m.Entries, &MyKV{})
