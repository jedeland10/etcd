...
replace (
	...
	go.etcd.io/raft/v3 => github.com/jedeland10/raft v0.0.0-20260303232218-79f630b60af4
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20260304183417-467e7e128f71 // indirect
