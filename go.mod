...
replace (
	...
	go.etcd.io/raft/v3 => github.com/jedeland10/raft v0.0.0-20260304203605-1b209808d3ad
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20260304201956-13629e572c9d // indirect
