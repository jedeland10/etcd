...
replace (
	...
	go.etcd.io/raft/v3 v3.6.0-beta.0 => github.com/jedeland10/raft v0.0.0-20260303113949-2d9a022b9287
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20260303113949-2d9a022b9287 // indirect
