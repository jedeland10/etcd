...
replace (
	...
	// go.etcd.io/raft/v3 v3.6.0-beta.0 => /home/johan-edeland/Documents/plugg/thesis/raft
	go.etcd.io/raft/v3 v3.6.0-beta.0 => github.com/jedeland10/raft v0.0.0-20250319211614-e183a58b1dec
)
