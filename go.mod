...
replace (
	...
	go.etcd.io/raft/v3 v3.6.0-beta.0 => github.com/jedeland10/raft v0.0.0-20251108181426-4e07c846f86f
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20251108181426-4e07c846f86f // indirect
