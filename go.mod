...
replace (
	...
	go.etcd.io/raft/v3 v3.6.0-beta.0 => github.com/jedeland10/raft v0.0.0-20260111163622-3e39bec6c095
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20260111172227-42cee4f5a2cb // indirect
