...
replace (
	...
	go.etcd.io/raft/v3 => github.com/jedeland10/raft v0.0.0-20260308193204-6cfabddd6056
)
...
require (
	...
	github.com/jedeland10/raft v0.0.0-20260308193204-6cfabddd6056 // indirect
